...
var s_account="rcrtsuumojpspprd";
// リフォーム領域の場合にs_accountを追加
var remodelFlg = remodelFlg || false;
if(location.pathname.split('/')[1] == 'remodel' || remodelFlg){
	s_account += ',rcrtsuumoremodelspprd';
}
...
if (location.hostname == "jj.jp.msn.com") {
  s.cookieDomainPeriods="4";
  if (location.pathname.match(/^\/bbs\//)) {
    s.cn_postfix="_jj_jp_msn_com_bbs";
  } else {
    s.cn_postfix="_jj_jp_msn_com";
  }
} else if (location.hostname.match(/inaka\.suumo\.jp$/)) {
...
s.linkInternalFilters="javascript:,tel:,suumo.jp,forrent.jp,img01.suumo.com,homepro.jp,point.recruit.co.jp,suumo-onr.jp,suumocounter.jp,suumoreformstore.jp,officemovement.com,goodreform.jp"
// filter setting end
...
//	s.prop10=s.eVar4="";
	...
	*****************************************/
	...
	s.myPath=location.pathname.replace(/^\/sp\//,'/');
